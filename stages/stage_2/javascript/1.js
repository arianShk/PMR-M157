window.HUB_EVENTS = {
  ASSET_ADDED: "ASSET_ADDED", //Wenn ein Asset (Artikel, Bild, Video oder Rohdatei) zur Libary hinzugefügt wird. Ein Objekt kann aus verschiedenen Gründen zur Libary hinzugefügt werden, einschließlich, aber nicht beschränkt auf das Hochladen von Objekten, das Abschließen einer Aufgabe usw.
  ASSET_DELETED: "ASSET_DELETED", //Wenn ein Asset (Artikel, Bild, Video oder Rohdatei) von der Libary gelöscht werden soll. Ein Objekt kann aus verschiedenen Gründen zur Libary hinzugefügt werden, einschließlich, aber nicht beschränkt auf das Hochladen von Objekten, das Abschließen einer Aufgabe usw.
